...
INVENTORY_BASE_OFFSET = 0x01179560
INVENTORY_QUANTITY_OFFSET = 0x1179564
IS_IN_DELAY_OFFSET = 0xDD1850

# From game base address
WORLD_BASE_INTERMED_OFFSET = 0x00D95084
PLAYER_NAME_OFFSET = 0x1180098
PLAYER_CURRENT_HP_OFFSET = 0x117D400
PLAYER_MAX_HP_OFFSET     = 0x117D404
PLAYER_CURRENT_SP_OFFSET = 0x117D40C
PLAYER_MAX_SP_OFFSET     = 0x117D408
PLAYER_COORDINATE_X_OFFSET = 0x1165C24
PLAYER_COORDINATE_Y_OFFSET = 0x1165C28
MAP_NAME_OFFSET = 0xD95088
